...
// Returns the SAME funnel stage the Businesses page shows, for every listing
// in a city, keyed by GHL contact id so it can be joined to that territory's
// GoHighLevel opportunities.
//
// Exists because seeding a territory's GHL pipeline is a per-city operation
// that repeats: Lincoln was staged from this on 2026-08-12, Tracy next, and
// Rocklin/Roseville after. Read-only and secret-gated — it computes nothing
// and writes nothing, it only reports what the Businesses page would show.
//
