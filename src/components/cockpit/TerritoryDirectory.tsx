...
//   exists.
// BusinessStage + computeBusinessStage now live in lib/businessStage.ts
// so server code can use them too (a "use client" export cannot be
// called from a route handler). Re-exported here so every existing
// importer of this module keeps working unchanged.
import { computeBusinessStage, type BusinessStage } from "@/lib/businessStage";
