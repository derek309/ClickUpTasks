...
const taskToRow = (t: Task, updatedBy?: string | null) => ({
  ...
  recurrence_days_of_month: t.recurrenceDaysOfMonth ?? null, follow_up_at: t.followUpAt ?? null, priority_auto: t.priorityAuto ?? false, recurrence_nth: t.recurrenceNth ?? null, recurrence_weekday: t.recurrenceWeekday ?? null,
...
export const rowToTask = (r: any): Task => ({
  ...
  recurrenceDaysOfMonth: r.recurrence_days_of_month ?? undefined, followUpAt: r.follow_up_at ?? null, priorityAuto: r.priority_auto ?? false, recurrenceNth: r.recurrence_nth ?? undefined, recurrenceWeekday: r.recurrence_weekday ?? undefined,
